...
You can check them in more details [[https://ziglang.org/documentation/master/#Build-Mode][here]]

There are also a few other options you can tweak like avx [[https://gcc.gnu.org/onlinedocs/gcc/Optimize-Options.html][here]]

*** Generate automatically documentation
...
*** Different code examples benchmark
...
In the first block, he multiples each letter of the city by 31.
After that, he sums up all the results.

In the second block, he checks if the hash can be inserted into the hashmap.
